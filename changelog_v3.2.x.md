...
## tag v3.2.0-beta.1 - 2019-11-27 (v3.5.2-beta.1)
...
## tag v3.2.0-alpha.6 - 2019-11-24 (v3.5.2-alpha.6)
...
## tag v3.2.0-alpha.5 - 2019-11-21 (v3.5.2-alpha.5)
...
## tag v3.2.0-alpha.4 - 2019-11-18 (v3.5.2-alpha.4)
...
## tag v3.2.0-alpha.2 - 2019-11-14 (v3.5.2-alpha.2)
...
## tag v3.2.0-alpha.1 - 2019-11-13 (v3.5.2-alpha.1)
...
## tag v3.2.0-alpha.1 - 2019-11-11 (v3.5.1)
...
## tag v3.2.0-alpha.1 - 2019-11-08

I initially forked this plugin and started to tag it with version 3.5.0 to set a steak in the
ground and to establish the versioning. Eventually the fork was merged back in to 
the main with a version of v3.2.0, so hence the renumbering of the versions within 
this document.  I'm keeping the v3.5.x references since the individual commits may
have them in a few resources.


Originally I decided to go with version 3.5.0 since I do not want to conflict with the 

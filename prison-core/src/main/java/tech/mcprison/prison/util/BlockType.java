...
public enum BlockType {
	 ...
	 * 
	 * Some spigot code to check against preexisting blocks and to see what blocks are
	 * not represented. Using the enum name is not a good matche overall:
	 * 
	 *         // Test BlockType and identify what kind it really is (ie... block or not):
        // Only print the first 100:
        // NOTE that Output.get() is not yet initialized yet:
        boolean blocksFoundHeader = false;
        int i = 0;
        for ( BlockType bType : BlockType.values() ) {
			if ( bType.getMaterialType() == MaterialType.NOT_SET ) {
				Material mat = Material.getMaterial( bType.name() );
				
				if ( mat != null && (mat.isBlock() || mat.isRecord() )) {
					if (!blocksFoundHeader) {
						System.out.println( "Prison: Found blocks that are not tagged with MaterialType.BLOCK:" );
						blocksFoundHeader = true;
					}
					
					System.out.println( "Prison: " + i++ + "  BlockType: " + bType.name() + "  ::  " +
							(mat.isBlock() ? " BLOCK" : "") + (mat.isRecord() ? " RECORD" : "") );
				} else if ( mat != null && !mat.isBlock() && bType.isBlock() ) {
					System.out.println( "Prison: &3Error&r " + i + " BlockType: " + bType.name() + 
							"  not a BLOCK !!" );
				} 
        ...
        System.out.println("Prison: Missing BlockTypes that are a block within the current version of Spigot:");
        int j = 0;
        for ( Material mat : Material.values() )
		{
			if ( mat != null && mat.isBlock() ) {
				BlockType bType = BlockType.getBlock( mat.name() );
				
				if (bType == null || !bType.isBlock()) {
					
					// Missing BlockType that is a block!
					
					System.out.print( mat.name() + "( MaterialType.BLOCK ), " );
...
/*	
	// Blocks missing from Spigot v1.8.8:
	
	WOOD( MaterialType.BLOCK ),
	SAPLING( MaterialType.BLOCK ),
	WATER( MaterialType.BLOCK ),
	STATIONARY_WATER( MaterialType.BLOCK ),
	LAVA( MaterialType.BLOCK ),
	STATIONARY_LAVA( MaterialType.BLOCK ),
	LOG( MaterialType.BLOCK ),
	LEAVES( MaterialType.BLOCK ),
	LAPIS_ORE( MaterialType.BLOCK ),
	LAPIS_BLOCK( MaterialType.BLOCK ),
	BED_BLOCK( MaterialType.BLOCK ),
	PISTON_STICKY_BASE( MaterialType.BLOCK ),
	WEB( MaterialType.BLOCK ),
	LONG_GRASS( MaterialType.BLOCK ),
	PISTON_BASE( MaterialType.BLOCK ),
	PISTON_EXTENSION( MaterialType.BLOCK ),
	WOOL( MaterialType.BLOCK ),
	PISTON_MOVING_PIECE( MaterialType.BLOCK ),
	YELLOW_FLOWER( MaterialType.BLOCK ),
	RED_ROSE( MaterialType.BLOCK ),
	DOUBLE_STEP( MaterialType.BLOCK ),
	STEP( MaterialType.BLOCK ),
	MOSSY_COBBLESTONE( MaterialType.BLOCK ),
	MOB_SPAWNER( MaterialType.BLOCK ),
	WOOD_STAIRS( MaterialType.BLOCK ),
	WORKBENCH( MaterialType.BLOCK ),
	CROPS( MaterialType.BLOCK ),
	SOIL( MaterialType.BLOCK ),
	SIGN_POST( MaterialType.BLOCK ),
	WOODEN_DOOR( MaterialType.BLOCK ),
	RAILS( MaterialType.BLOCK ),
	WALL_SIGN( MaterialType.BLOCK ),
	STONE_PLATE( MaterialType.BLOCK ),
	WOOD_PLATE( MaterialType.BLOCK ),
	SUGAR_CANE_BLOCK( MaterialType.BLOCK ),
	FENCE( MaterialType.BLOCK ),
	PORTAL( MaterialType.BLOCK ),
	JACK_O_LANTERN( MaterialType.BLOCK ),
	DIODE_BLOCK_OFF( MaterialType.BLOCK ),
	DIODE_BLOCK_ON( MaterialType.BLOCK ),
	STAINED_GLASS( MaterialType.BLOCK ),
	TRAP_DOOR( MaterialType.BLOCK ),
	MONSTER_EGGS( MaterialType.BLOCK ),
	SMOOTH_BRICK( MaterialType.BLOCK ),
	HUGE_MUSHROOM_1( MaterialType.BLOCK ),
	HUGE_MUSHROOM_2( MaterialType.BLOCK ),
	IRON_FENCE( MaterialType.BLOCK ),
	THIN_GLASS( MaterialType.BLOCK ),
	VINE( MaterialType.BLOCK ),
	FENCE_GATE( MaterialType.BLOCK ),
	SMOOTH_STAIRS( MaterialType.BLOCK ),
	MYCEL( MaterialType.BLOCK ),
	WATER_LILY( MaterialType.BLOCK ),
	NETHER_FENCE( MaterialType.BLOCK ),
	NETHER_WARTS( MaterialType.BLOCK ),
	ENDER_PORTAL( MaterialType.BLOCK ),
	ENDER_PORTAL_FRAME( MaterialType.BLOCK ),
	ENDER_STONE( MaterialType.BLOCK ),
	REDSTONE_LAMP_OFF( MaterialType.BLOCK ),
	REDSTONE_LAMP_ON( MaterialType.BLOCK ),
	WOOD_DOUBLE_STEP( MaterialType.BLOCK ),
	WOOD_STEP( MaterialType.BLOCK ),
	COMMAND( MaterialType.BLOCK ),
	COBBLE_WALL( MaterialType.BLOCK ),
	WOOD_BUTTON( MaterialType.BLOCK ),
	SKULL( MaterialType.BLOCK ),
	GOLD_PLATE( MaterialType.BLOCK ),
	IRON_PLATE( MaterialType.BLOCK ),
	REDSTONE_COMPARATOR_OFF( MaterialType.BLOCK ),
	REDSTONE_COMPARATOR_ON( MaterialType.BLOCK ),
	DAYLIGHT_DETECTOR( MaterialType.BLOCK ),
	QUARTZ_ORE( MaterialType.BLOCK ),
	STAINED_CLAY( MaterialType.BLOCK ),
	STAINED_GLASS_PANE( MaterialType.BLOCK ),
	LEAVES_2( MaterialType.BLOCK ),
	LOG_2( MaterialType.BLOCK ),
	ACACIA_STAIRS( MaterialType.BLOCK ),
	DARK_OAK_STAIRS( MaterialType.BLOCK ),
	HAY_BLOCK( MaterialType.BLOCK ),
	CARPET( MaterialType.BLOCK ),
	HARD_CLAY( MaterialType.BLOCK ),
	COAL_BLOCK( MaterialType.BLOCK ),
	DOUBLE_PLANT( MaterialType.BLOCK ),
	STANDING_BANNER( MaterialType.BLOCK ),
	WALL_BANNER( MaterialType.BLOCK ),
	DAYLIGHT_DETECTOR_INVERTED( MaterialType.BLOCK ),
	DOUBLE_STONE_SLAB2( MaterialType.BLOCK ),
	STONE_SLAB2( MaterialType.BLOCK ),

*/
	
/*
 * Blocks missing from 1.9.4


Prison: Missing BlockTypes that are a block within the current version of Spigot:
WOOD( MaterialType.BLOCK ),
SAPLING( MaterialType.BLOCK ),
WATER( MaterialType.BLOCK ),
STATIONARY_WATER( MaterialType.BLOCK ),
...
DOUBLE_STONE_SLAB2( MaterialType.BLOCK ),
STONE_SLAB2( MaterialType.BLOCK ),
END_ROD( MaterialType.BLOCK ),
CHORUS_PLANT( MaterialType.BLOCK ),
CHORUS_FLOWER( MaterialType.BLOCK ),
PURPUR_BLOCK( MaterialType.BLOCK ),
PURPUR_PILLAR( MaterialType.BLOCK ),
PURPUR_STAIRS( MaterialType.BLOCK ),
PURPUR_DOUBLE_SLAB( MaterialType.BLOCK ),
PURPUR_SLAB( MaterialType.BLOCK ),
END_BRICKS( MaterialType.BLOCK ),
BEETROOT_BLOCK( MaterialType.BLOCK ),
GRASS_PATH( MaterialType.BLOCK ),
END_GATEWAY( MaterialType.BLOCK ),
COMMAND_REPEATING( MaterialType.BLOCK ),
COMMAND_CHAIN( MaterialType.BLOCK ),
FROSTED_ICE( MaterialType.BLOCK ),
STRUCTURE_BLOCK( MaterialType.BLOCK ), 
 * 
 */
	
/*
 * Blocks missing from 1.10.2:
[Prison] Loading Prison v3.5.2-beta.1
...
COMMAND_CHAIN( MaterialType.BLOCK ),
FROSTED_ICE( MaterialType.BLOCK ),
MAGMA( MaterialType.BLOCK ),
NETHER_WART_BLOCK( MaterialType.BLOCK ),
RED_NETHER_BRICK( MaterialType.BLOCK ),
BONE_BLOCK( MaterialType.BLOCK ),
STRUCTURE_VOID( MaterialType.BLOCK ),
STRUCTURE_BLOCK( MaterialType.BLOCK ),
	
 */
	
/*
 * Blocks missing from Spigot 1.11:
 * 
[Prison] Loading Prison v3.5.2-beta.1
...
BONE_BLOCK( MaterialType.BLOCK ),
STRUCTURE_VOID( MaterialType.BLOCK ),
OBSERVER( MaterialType.BLOCK ),
WHITE_SHULKER_BOX( MaterialType.BLOCK ),
ORANGE_SHULKER_BOX( MaterialType.BLOCK ),
MAGENTA_SHULKER_BOX( MaterialType.BLOCK ),
LIGHT_BLUE_SHULKER_BOX( MaterialType.BLOCK ),
YELLOW_SHULKER_BOX( MaterialType.BLOCK ),
LIME_SHULKER_BOX( MaterialType.BLOCK ),
PINK_SHULKER_BOX( MaterialType.BLOCK ),
GRAY_SHULKER_BOX( MaterialType.BLOCK ),
SILVER_SHULKER_BOX( MaterialType.BLOCK ),
CYAN_SHULKER_BOX( MaterialType.BLOCK ),
PURPLE_SHULKER_BOX( MaterialType.BLOCK ),
BLUE_SHULKER_BOX( MaterialType.BLOCK ),
BROWN_SHULKER_BOX( MaterialType.BLOCK ),
GREEN_SHULKER_BOX( MaterialType.BLOCK ),
RED_SHULKER_BOX( MaterialType.BLOCK ),
BLACK_SHULKER_BOX( MaterialType.BLOCK ),
STRUCTURE_BLOCK( MaterialType.BLOCK ),	
 */

/*
 * Blocks missing from Spigot 1.12.2:
 * 
[Prison] Loading Prison v3.5.2-beta.1
...
RED_SHULKER_BOX( MaterialType.BLOCK ),
BLACK_SHULKER_BOX( MaterialType.BLOCK ),
WHITE_GLAZED_TERRACOTTA( MaterialType.BLOCK ),
ORANGE_GLAZED_TERRACOTTA( MaterialType.BLOCK ),
MAGENTA_GLAZED_TERRACOTTA( MaterialType.BLOCK ),
LIGHT_BLUE_GLAZED_TERRACOTTA( MaterialType.BLOCK ),
YELLOW_GLAZED_TERRACOTTA( MaterialType.BLOCK ),
LIME_GLAZED_TERRACOTTA( MaterialType.BLOCK ),
PINK_GLAZED_TERRACOTTA( MaterialType.BLOCK ),
GRAY_GLAZED_TERRACOTTA( MaterialType.BLOCK ),
SILVER_GLAZED_TERRACOTTA( MaterialType.BLOCK ),
CYAN_GLAZED_TERRACOTTA( MaterialType.BLOCK ),
PURPLE_GLAZED_TERRACOTTA( MaterialType.BLOCK ),
BLUE_GLAZED_TERRACOTTA( MaterialType.BLOCK ),
BROWN_GLAZED_TERRACOTTA( MaterialType.BLOCK ),
GREEN_GLAZED_TERRACOTTA( MaterialType.BLOCK ),
RED_GLAZED_TERRACOTTA( MaterialType.BLOCK ),
BLACK_GLAZED_TERRACOTTA( MaterialType.BLOCK ),
CONCRETE( MaterialType.BLOCK ),
CONCRETE_POWDER( MaterialType.BLOCK ),
STRUCTURE_BLOCK( MaterialType.BLOCK ),
 */
	
	
/*
 * The following blocks are missing from Spigot 1.13.4:
 * 
[Prison] Loading Prison v3.5.2-beta.1
...
/*
 * The following blocks are missing from Spigot 1.14.4:
[Prison] Loading Prison v3.5.2-beta.1

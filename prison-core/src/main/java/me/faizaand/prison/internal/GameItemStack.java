...
public class GameItemStack {
    ...
    public GameItemStack(String displayName, int amount, BlockType material, String... lore) {
    ...
    public GameItemStack(int amount, BlockType material, String... lore) {
        this.amount = amount;
        this.material = material;
        this.lore = new ArrayList<>(Arrays.asList(lore));
    }
    ...
    @Override public boolean equals(Object o) {
        ...
        GameItemStack stack = (GameItemStack) o;
    ...
    @Override public String toString() {
        return "GameItemStack{" + "displayName='" + displayName + '\'' + ", amount=" + amount

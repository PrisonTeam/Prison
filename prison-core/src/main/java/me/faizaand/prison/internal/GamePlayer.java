 ...
 * @since API 1.0
 */
public interface GamePlayer extends CommandSender, InventoryHolder {
    ...
    /**
     * Adds an {@link GameItemStack} to the player's inventory.
     */
    void give(GameItemStack itemStack);

    /**
     * Returns the player's current {@link GameLocation}.
     */
     ...
     *
     * @param location The new {@link GameLocation}.
     */
    void teleport(GameLocation location);

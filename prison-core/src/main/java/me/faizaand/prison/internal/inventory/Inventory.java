 ...
 */
public interface Inventory extends Iterable<GameItemStack> {
    ...
    /**
     * The maximum size that an {@link GameItemStack} can be in this inventory.
     *
    ...
    /**
     * Set the maximum size that an {@link GameItemStack} can be in this inventory.
     *
    ...
    /**
     * Returns whether the {@link GameItemStack} is contained by the inventory.
     *
     * @param itemStack The {@link GameItemStack} to look for. Note that the amount of this stack will be
     ...
     */
    boolean contains(GameItemStack itemStack);
    ...
    Iterator<GameItemStack> getIterator();

    /**
     * Returns an array of all the items in this inventory.
     *
     * @return An array of {@link GameItemStack}.
     */
    GameItemStack[] getItems();
     ...
     */
    void setItems(List<GameItemStack> items);
     ...
     * as the values
     */
    HashMap<Integer, GameItemStack> getItems(BlockType type);

    /**
     * Creates a {@link HashMap} with items matching the specified {@link GameItemStack}
     *
     * @param stack the {@link GameItemStack} to check the inventory contents against.
     * @return a HashMap with the index of items with matching items as the keys, and said items as
     * the values
     */
    HashMap<Integer, GameItemStack> getItems(GameItemStack stack);
     ...
     */
    GameItemStack getItem(int index);
     ...
     */
    void addItem(GameItemStack... itemStack);
     ...
     */
    void removeItem(GameItemStack... itemStack);
    ...
    /**
     * Clears all the slots matching the specified {@link GameItemStack}
     *
     * @param stack the {@link GameItemStack} to remove from this inventory
     */
    void clear(GameItemStack stack);

    /**
     * Gets the index of the first instance of the specified {@link GameItemStack} in this inventory.
     *
     * @param stack the item to get the first index of
     * @return the first index of the item
     */
    int first(GameItemStack stack);

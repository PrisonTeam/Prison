...
package me.faizaand.prison.internal.block;
...
public interface Block {
     ...
     *
     * @return The {@link GameLocation} of the block.
     */
     ...
     * @return A list of dropped items for this type of block.
     */
    List<GameItemStack> getDrops(GameItemStack tool);

...
package me.faizaand.prison.chat;
...
import me.faizaand.prison.util.ChatColor;
 ...
 * will append a new editing component to the end of the message, optionally initializing it with
 * text. Further property-setting method calls will affect that editing component. </p>
 */
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart> {
     ...
     * @return This builder instance.
     * @throws IllegalArgumentException If the specified {@code ChatColor} enumeration value is not a
     ...
     * @return This builder instance.
     * @throws IllegalArgumentException If any of the enumeration values in the array do not represent
     *                                  formatters.
     */
     ...
     * executed unless the client player submits the command/chat message, usually with the enter
     * key.
     *
     ...
     * input box content with the specified string when the currently edited part of the {@code
     * FancyMessage} is SHIFT-CLICKED. The client will not immediately send the command to the server
     * to be executed unless the client player submits the command/chat message, usually with the
     * enter key.
     *
    ...
    */
     ...
     * text when the client hovers over the text. <p>Tooltips do not inherit display characteristics,
     ...
     */
    public void send(GamePlayer player) {
    ...
    /**
     * Convert this message to a human-readable string with limited formatting. This method is used to
     * send this message to clients without JSON formatting support. <p> Serialization of this message
     * by using this message will include (in this order for each message part): <ol> <li>The color of
     * each message part.</li> <li>The applicable stylizations for each message part.</li> <li>The
     * core text of the message part.</li> </ol> The primary omissions are tooltips and clickable
     * actions. Consequently, this method should be used only as a last resort. <p> <p> Color and
     * formatting can be removed from the returned string by using {@link
     * ChatColor#stripColor(String)}.</p>
     *
     * @return A human-readable string representing limited formatting in addition to the core text of
     * this message.
     */

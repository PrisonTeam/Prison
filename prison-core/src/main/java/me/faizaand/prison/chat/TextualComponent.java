...
public abstract class TextualComponent implements Cloneable {
    ...
    static boolean isTranslatableText(TextualComponent component) {
        return component instanceof ComplexTextTypeComponent
            && component.getKey().equals("translate");
    }
     ...
     * client resource pack, the translation key will be displayed as a string literal to the client.
     * </p>
     *
    ...
    /**
     * Create a textual component representing a scoreboard value. The client will see their own score
     * for the specified objective as the text represented by this component. <p> <b>This method is
     * currently guaranteed to throw an {@code UnsupportedOperationException} as it is only supported
     * on snapshot clients.</b> </p>
     *
     ...
     * the specified player for the specified objective as the text represented by this component. <p>
     * <b>This method is currently guaranteed to throw an {@code UnsupportedOperationException} as it
     * is only supported on snapshot clients.</b> </p>
     *
     ...
     * selector as the text represented by this component. <p> <b>This method is currently guaranteed
     * to throw an {@code UnsupportedOperationException} as it is only supported on snapshot
     * clients.</b> </p>
     *
     * @param selector The minecraft player or entity selector which will capture the entities whose
     *                 string representations will be displayed in the place of this text component.

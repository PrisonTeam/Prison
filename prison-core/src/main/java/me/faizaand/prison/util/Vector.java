...
public class Vector implements Cloneable {
    ...
    /**
     * Gets a GameLocation version of this vector with yaw and pitch being 0.
     *
     * @param world The world to link the location to.
     * @return the location
     */
    public GameLocation toLocation(GameWorld world) {
        return new GameLocation(world, x, y, z);
    }

    /**
     * Gets a GameLocation version of this vector.
     *
     * @param world The world to link the location to.
     ...
     * @return the location
     */
    public GameLocation toLocation(GameWorld world, float yaw, float pitch) {

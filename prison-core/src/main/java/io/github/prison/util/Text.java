...
public class Text {
    ...
    public static String implode(String[] text, String glue) {
        ...
        for (String t : text) builder.append(t).append(glue);
     ...
     * <p>
     * <p>Use of this method is discouraged. Implementations are recommended to translate color codes using their native platform's
    ...
    public static String translateColorCodes(String text, char prefix) {
        if (prefix == 167) return text; // No need to translate, it's already been translated

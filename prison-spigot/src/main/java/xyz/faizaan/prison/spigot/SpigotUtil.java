...
public class SpigotUtil {
   ...
   */
    ...
    public static xyz.faizaan.prison.internal.ItemStack bukkitItemStackToPrison(
        ItemStack bukkitStack) {
        if (bukkitStack == null || bukkitStack.getType().equals(Material.AIR)) {
            return new xyz.faizaan.prison.internal.ItemStack(0, BlockType.AIR);
        }
        ...
        return new xyz.faizaan.prison.internal.ItemStack(displayName, amount, type, lore_arr);
    }

    public static ItemStack prisonItemStackToBukkit(
        xyz.faizaan.prison.internal.ItemStack prisonStack) {

...
public class MessagesConfig extends SpigotConfigComponents{
    ...
    private void values(){
        ...
        dataConfig("Message.SellAllIsDisabled", "&3[PRISON ERROR]&c Sorry but the SellAll Feature's disabled in the config.yml");
        dataConfig("Message.SellAllEditedWithSuccess", "] edited with success!");
        dataConfig("Message.SellAllSubCommandNotFound", "&3[PRISON WARN] The first argument's not found, please try /sellall for a list of them!");
        dataConfig("Message.SellAllMultipliersAreDisabled", "&3[PRISON WARN] &cMultipliers are disabled in the SellAll config!");
        dataConfig("Message.SellAllMultiplierWrongFormat", "&c[PRISON WARN] &cWrong format, please use /sellall multiplier add/delete <Prestige> <Multiplier>");
        dataConfig("Message.SellAllMissingPermission", "&3[PRISON WARN] &cSorry, but you don't have the permission [");
        dataConfig("Message.SellAllRanksDisabled", "&3[PRISON ERROR] &cThe Ranks module's disabled or not found!");
        dataConfig("Message.SellAllPrestigeLadderNotFound", "&3[PRISON WARN] &cCan't find a -prestiges- ladder, they might be disabled in the config.yml.");
        dataConfig("Message.SellAllCantFindPrestigeOrRank", "&3[PRISON WARN] &cCan't find the Prestige/Rank: ");
        dataConfig("Message.SellAllRankNotFoundInPrestigeLadder", "&3[PRISON WARN] &cThe -prestiges- ladder doesn't contains the Rank: ");
        dataConfig("Message.SellAllMultiplierNotANumber", "&3[PRISON WARN]&c Sorry but the multiplier isn't a number [/sellall multiplier add ");
        dataConfig("Message.SellAllMultiplierNotNumber2", " Here-> ");
        dataConfig("Message.SellAllConfigSaveFail", "&3[PRISON ERROR] &cSorry, the config didn't save with success!");
        dataConfig("Message.SellAllMultiplierEditSaveSuccess", "&3[PRISON] &aMultiplier got added or edited with success!");
        dataConfig("Message.SellAllMultiplierFormat", "&3[PRISON WARN] &cPlease use a format like /sellall multiplier delete <Prestige>");
        dataConfig("Message.SellAllCantFindMultiplier", "&3[PRISON WARN] &cCan't find the Multiplier of the prestige ");
        dataConfig("Message.SellAllCantFindMultiplier2", " in the sellallconfig.yml");
        dataConfig("Message.SellAllMultiplierDeleteSuccess", "&3[PRISON WARN] &aMultiplier deleted with success!");
        dataConfig("Message.SellAllWrongFormatCommand", "&3[PRISON WARN] &cThe format's wrong, try again /sellall for info.");
        dataConfig("Message.SellAllPleaseAddItem", "&3[PRISON WARN]&c Please add an ITEM_ID [example: /sellall add COAL_ORE <price>]");
        dataConfig("Message.SellAllAddPrice", "&3[PRISON WARN]&c Please add a price or value for the item [example: /sellall add COAL_ORE 100]");
        dataConfig("Message.SellAllWrongID", "&3[PRISON WARN]&c Sorry but the ITEM_ID's wrong, please check it [/sellall");
        dataConfig("Message.SellAllValueNotNumber", "&3[PRISON WARN]&c Sorry but the value isn't a number [/sellall");
        dataConfig("Message.SellAllMissingID", "&3[PRISON WARN]&c Please add an ITEM_ID [example: /sellall delete COAL_ORE]");
        dataConfig("Message.SellAllTagWarn", "&3[PRISON WARN]&c ");
        dataConfig("Message.SellAllNotFoundStringConfig", " not found in the config or got already deleted");
        dataConfig("Message.SellAllPrisonTag", "&3[PRISON]&a ");
        ...
        dataConfig("Message.SellAllYouArentPlayer", "&3[PRISON ERROR]&c You aren't a player");
        dataConfig("Message.SellAllNothingToSell", "&3[PRISON]&c You have nothing to sell!");
        dataConfig("Message.SellAllYouGotMoney", "&3[PRISON]&a You got $");
        dataConfig("Message.SellAllGUIDisabled", "&c[PRISON ERROR] Sorry but the GUI's disabled in the SellAllConfig.yml");

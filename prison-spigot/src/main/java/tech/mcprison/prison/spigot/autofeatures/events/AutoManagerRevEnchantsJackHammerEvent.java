...
//			}
	...
	public void handleRevEnchantsJackHammerEvent(JackHammerEvent e, BlockBreakPriority bbPriority) {
		...
		debugInfo.append(String.format(
				"&6### ** handleRevEnchantsJackHammerEvent ** ###&3 "
...
//						bbPriority, 
			...
			String msg = String.format("(JackHammerEvent: e.blocks=%d  locationBlocks=%d  %s %s) ",
					e.getBlocks().size(), blocks.size(), loc1.toWorldCoordinates(), loc2.toWorldCoordinates());

...
public class SpigotMineBlockPercentageGUI extends SpigotGUIComponents {
    ...
    public void open() {
        ...
        ButtonLore confirmButtonLore = new ButtonLore(createLore(
        		messages.getString(MessagesConfig.StringID.spigot_gui_lore_click_to_confirm), 
        ...
        gui.addButton(new Button(22, XMaterial.CLOCK, 1, confirmButtonLore, "&3Confirm: " + mineName + " " + blockName +  " " + val + " &0" + counter));

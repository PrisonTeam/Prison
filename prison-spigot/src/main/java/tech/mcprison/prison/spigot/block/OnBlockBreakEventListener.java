...
//		
//		OnBlockBreakExternalEvents.getInstance().checkWorldGuard( e );
//
//		Output.get().logDebug( "### 1: outside ### On BlockBreakEvent: monitor=" + monitor + 
//								" blockEventsOnly=" + blockEventsOnly + " isEventCancled=" + e.isCancelled() );
//		
//		
//		
...
//    	{
//    		
//    		Output.get().logDebug( "### 2: inside ### On BlockBreakEvent: monitor=" + monitor + 
//    							" blockEventsOnly=" + blockEventsOnly + " isEventCancled=" + e.isCancelled() );
//    		

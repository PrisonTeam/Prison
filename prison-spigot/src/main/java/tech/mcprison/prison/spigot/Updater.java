...
//            if (createFile) {
//                message = "The updater could not create configuration at " + updaterFile
//                    .getAbsolutePath();
//            } else {
//                message =
...
//                File destinationFilePath = new File(zipPath, entry.getName());.
	// The following "if" has been provided by Jonathan Leitschuh <Jonathan.Leitschuh@gmail.com> and 
	// addresses a zip-slip-vulnerability exploit with zip files.  This exploit can take over 
	// a server.
...
//                        new BufferedOutputStream(fos, Updater.BYTE_SIZE);
...
//                // Current dir
//                final File oFile =
//                    new File(this.plugin.getDataFolder().getParent(), dFile.getName());
...
//                    title.split(DELIMETER)[title.split(DELIMETER).length - 1].split(" ")[0];
//
...
//        if (!result) {
//            this.plugin.getLogger().severe(
//                "The updater could not " + (create ? "create" : "delete") + " file at: " + file
//                    .getAbsolutePath());
//        }
//    }
//

...
public class SpigotInventory implements Inventory {
  ...
  @Override
  public HashMap<Integer, ItemStack> getItems(BlockType type) {
  ...
  @Override
  public HashMap<Integer, ItemStack> getItems(ItemStack stack) {
    HashMap<Integer, ItemStack> result = new HashMap<>();
    List<ItemStack> items = Arrays.asList(getItems());
  ...
  @Override
  public void clear(BlockType type) {
  ...
  @Override
  public int first(BlockType type) {

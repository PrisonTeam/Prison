...
public class SpigotCrafting extends SpigotInventory implements CraftingInventory {
    ...
    @Override public Recipe getRecipe() {
        if (((org.bukkit.inventory.CraftingInventory) getWrapper()).getRecipe() instanceof FurnaceRecipe){
            return new SpigotFurnaceRecipe((org.bukkit.inventory.FurnaceRecipe) ((org.bukkit.inventory.CraftingInventory) getWrapper()).getRecipe());
        }
        else if (((org.bukkit.inventory.CraftingInventory) getWrapper()).getRecipe() instanceof ShapelessRecipe){
            return new SpigotShapelessRecipe((org.bukkit.inventory.ShapelessRecipe) ((org.bukkit.inventory.CraftingInventory) getWrapper()).getRecipe());
        }
        else if (((org.bukkit.inventory.CraftingInventory) getWrapper()).getRecipe() instanceof org.bukkit.inventory.ShapedRecipe){
            return new SpigotShapedRecipe((org.bukkit.inventory.ShapedRecipe) ((org.bukkit.inventory.CraftingInventory) getWrapper()).getRecipe());
        }
        else {
            return null;
        }
    ...
    @Override public ItemStack getResult() {
        return SpigotUtil.bukkitItemStackToPrison(((org.bukkit.inventory.CraftingInventory) getWrapper()).getResult());
    }
    ...
    @Override public void setMatrix(ItemStack[] contents) {
        ...
        ((org.bukkit.inventory.CraftingInventory) getWrapper()).setMatrix((org.bukkit.inventory.ItemStack[]) stacks.toArray());
    }

    @Override public void setResult(ItemStack newResult) {
        ((org.bukkit.inventory.CraftingInventory) getWrapper()).setResult(SpigotUtil.prisonItemStackToBukkit(newResult));
    }
}

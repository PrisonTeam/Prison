...
public class GuiConfig {
    ...
    private String[] getObject() {
        return new String[]{
                ...
                "&8Click to manage RankUPCommands.",
                "&8Click to open.",
                "&8Click to teleport.",
                "&8Click to use.",
                "&8Click to rankup",
                ...
                "&3Players with this rank: &7",
                "&3Price: &a$",
                "&8Price: &a$",
                "&3Rank Price: &a$",
                "&8Prison Tasks GUI manager.",
                "&3Reset time in seconds: &7",
                "&8Radius: ",
                "&8&l|&3RankUPCommands&8| &8&l- &3",
                "&aRankup", "&8Ranks GUI manager.",
                "&8Resets the mine.",
                ...
                "&cPress Shift + Right click to toggle",
                "&8Enabled",
                "&8Disabled",
                "&8Skip the reset if ",
                "&8not enough blocks ",

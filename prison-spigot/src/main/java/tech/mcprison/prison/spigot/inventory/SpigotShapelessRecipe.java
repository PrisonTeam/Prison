...
public class SpigotShapelessRecipe extends SpigotRecipe implements ShapelessRecipe {
  ...
  @Override
  public ShapelessRecipe addIngredient(int count, BlockType ingredient) {
  ...
  @Override
  public ShapelessRecipe addIngredient(BlockType ingredient) {
    ((org.bukkit.inventory.ShapelessRecipe) getWrapper())
  ...
  @Override
  public ShapelessRecipe removeIngredient(int count, BlockType ingredient) {
    ((org.bukkit.inventory.ShapelessRecipe) getWrapper())
  ...
  @Override
  public ShapelessRecipe removeIngredient(BlockType ingredient) {
    ((org.bukkit.inventory.ShapelessRecipe) getWrapper())

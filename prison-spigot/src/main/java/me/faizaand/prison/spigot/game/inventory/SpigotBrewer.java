...
import me.faizaand.prison.internal.inventory.BrewerInventory;
import me.faizaand.prison.internal.inventory.InventoryHolder;
import me.faizaand.prison.spigot.SpigotUtil;
import me.faizaand.prison.spigot.game.block.SpigotBrewingStand;
...
public class SpigotBrewer extends SpigotInventory implements BrewerInventory {
    ...
    @Override public GameItemStack getIngredient() {
        return SpigotUtil.bukkitItemStackToPrison(
            ((org.bukkit.inventory.BrewerInventory) getWrapper()).getIngredient());
    }

    @Override public void setIngredient(GameItemStack ingredient) {

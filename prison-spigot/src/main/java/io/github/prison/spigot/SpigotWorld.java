...
public class SpigotWorld implements World {
    ...
    public Block getBlockAt(Location location) {
        return Block.getBlock(bukkitWorld.getBlockAt(location.getBlockX(), location.getBlockY(), location.getBlockZ()).getTypeId());
    }

    @Override
    public void setBlockAt(Location location, Block block) {
        bukkitWorld.getBlockAt(location.getBlockX(), location.getBlockY(), location.getBlockZ()).setType(Material.getMaterial(block.getLegacyId()));
    }

...
import tech.mcprison.prison.ranks.events.RankDemoteEvent;
...
public class RankCommands {
    ...
    @Command(identifier = "ranks newrank", description = "Make a new rank", permissions = {
        "prison.ranks.newrank"}, onlyPlayers = false)
    ...
    @Command(identifier = "ranks settag", description = "Change the tag of a rank", permissions = {
        "prison.ranks.settag"}, onlyPlayers = false)
    public void setTagCommand(CommandSender sender, @Arg(name = "rankname") String name,
        @Arg(name = "tag") String tag) {
    ...
    @Command(identifier = "ranks setrank", description = "Set the rank of a player", permissions = {
        "prison.ranks.setrank"}, onlyPlayers = false)
    public void setRankCommand(CommandSender sender, @Arg(name = "player") String name,
        @Arg(name = "rank") String rank) {
    ...
    @Command(identifier = "ranks setcost", description = "set the cost of a rank", permissions = {
        "prison.ranks.setcost"}, onlyPlayers = false)
    public void setCostCommand(CommandSender sender, @Arg(name = "rankname") String rankName,
        @Arg(name = "cost") double cost) {
    ...
    @Command(identifier = "ranks checkrank", description = "Check the rank of a user", permissions = {
        "prison.ranks.checkrank"}, onlyPlayers = false)
    public void checkRankCommand(CommandSender sender, @Arg(name = "player") String name) {
        ...
        if (targ != null) {
            ...
            sender.sendMessage(String.format(Messages.commandCheckRank, targ.getName(),
    ...
    @Command(identifier = "ranks promote", description = "Promote a player's rank", permissions = {
        "prison.ranks.promote"}, onlyPlayers = false)
    public void promoteRankCommand(CommandSender sender, @Arg(name = "player") String name) {
        ...
        if (targ != null) {
            ...
            sender.sendMessage(String
                .format(Messages.commandPromote, targ.getName(), currentRank.getName(),
                    newRank.getName()));
        } else {
            sender.sendMessage(String.format(Messages.errorPlayerNotFound, name));
        }
    ...
    @Command(identifier = "ranks demote", description = "Demote a player's rank", permissions = {
        "prison.ranks.demote"}, onlyPlayers = false)
    public void demoteRankCommand(CommandSender sender, @Arg(name = "player") String name) {
        ...
        if (targ != null) {
            ...
            sender.sendMessage(String
                .format(Messages.commandDemote, targ.getName(), currentRank.getName(),
                    newRank.getName()));
        } else {
            sender.sendMessage(String.format(Messages.errorPlayerNotFound, name));
        }

 ...
 * @author SirFaizdat
 */
@Plugin(id = "prison-ranks", name = "PrisonRanks", version = "3.0.0-SNAPSHOT", description = "The ranks module for Prison.", dependencies = {
    @Dependency(id = "prison-sponge")}) public class RanksSponge {

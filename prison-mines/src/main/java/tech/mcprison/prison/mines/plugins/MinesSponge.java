 ...
 * @author SirFaizdat
 */
@Plugin(id = "prison-mines", name = "PrisonMines", version = "3.0.0-SNAPSHOT", description = "The mines module for Prison.", dependencies = {
    @Dependency(id = "prison-sponge")}) public class MinesSponge {

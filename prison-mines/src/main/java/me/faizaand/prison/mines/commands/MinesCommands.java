...
import me.faizaand.prison.selection.Selection;
...
public class MinesCommands {
    ...
    public void createCommand(CommandSender sender,
        ...
        Selection selection = Prison.get().getSelectionManager().getSelection((GamePlayer) sender);
    ...
    public void spawnpointCommand(CommandSender sender,
        ...
        if (!((GamePlayer) sender).getLocation().getWorld().getName()
            .equalsIgnoreCase(
        ...
        PrisonMines.getInstance().getMineManager().getMine(name).get()
            .setSpawn(((GamePlayer) sender).getLocation());
    ...
    public void wandCommand(GamePlayer sender) {

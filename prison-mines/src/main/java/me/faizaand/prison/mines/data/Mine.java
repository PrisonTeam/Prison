...
package me.faizaand.prison.mines.data;
...
public class Mine {
    ...
    private GameLocation min, max, spawn;
            ...
            for (int y = minY; y <= maxY; y++) {
                for (int x = minX; x <= maxX; x++) {
                    for (int z = minZ; z <= maxZ; z++) {
                        ...
                        new GameLocation(world, x, y, z).getBlockAt().setType(blockTypes.get(i));
                        i++;
                    }
                }
            }
     ...
     */
    public Optional<GameLocation> getSpawn() {
        if (!hasSpawn) {
     ...
     */
    public Mine setSpawn(GameLocation location) {
        hasSpawn = true;
        spawn = location;
        return this;
    }
    ...
    public boolean isInMine(GameLocation location) {

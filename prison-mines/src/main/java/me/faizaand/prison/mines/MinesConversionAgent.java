...
import me.faizaand.prison.convert.ConversionAgent;
        ...
        try {
            ...
            if (jsonFiles != null) {
                for (String jsonFile : jsonFiles) {
                    ...
                    Bounds bounds = new Bounds(new GameLocation(prisonWorld.get(), minX, minY, minZ),
                        new GameLocation(prisonWorld.get(), maxX, maxY, maxZ));
